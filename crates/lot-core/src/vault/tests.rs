//! Tests for [`Vault`]: they drive the public API (create/find/update/
//! archive/move) against temporary git-backed vaults. Kept as a child module
//! of `vault` (rather than an integration test) so they retain access to the
//! module internals they exercise.
